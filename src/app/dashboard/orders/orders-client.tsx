...
export default function OrdersClient() {
  ...
  return (
    <DashboardLayout>
      <Typography variant="h5" component="h1" fontWeight="bold" mb={3}>Orders</Typography>
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ bgcolor: 'grey.50' }}>
                <TableCell><Typography variant="body2" fontWeight="bold">Order</Typography></TableCell>
                <TableCell><Typography variant="body2" fontWeight="bold">Date</Typography></TableCell>
                <TableCell><Typography variant="body2" fontWeight="bold">Status</Typography></TableCell>
                <TableCell><Typography variant="body2" fontWeight="bold">Total</Typography></TableCell>
                <TableCell><Typography variant="body2" fontWeight="bold">Actions</Typography></TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {orders.map((order) => (
                <TableRow key={order.id} hover>
                  <TableCell>
                    <Typography variant="body2" fontWeight="medium">#{order.number}</Typography>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <Typography variant="body2">
                      {order.currency} {order.total} for {order.line_items.reduce((s, i) => s + i.quantity, 0)} item(s)
                    </Typography>
                  </TableCell>
                  <TableCell>
