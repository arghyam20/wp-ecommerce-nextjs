...
export default function SignupClient() {
  ...
  return (
    <Layout>
      <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh', px: 2, py: 4 }}>
        <Paper sx={{ p: 4, width: '100%', maxWidth: 480 }} elevation={3}>
          <Typography variant="h5" fontWeight="bold" textAlign="center" mb={3}>Create Account</Typography>
